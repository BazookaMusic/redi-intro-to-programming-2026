...
SAMPLE = ["Sara", "25", "Berlin", "Pizza", "Blue", "False"]
...
def check():
    ...
    expected = [str(variables[name]) for name in required]
    if actual != expected:
        fail(expected, actual, "Print each of your six values on its own line, in order.")
    print("Correct! Your output matches your variables.")
